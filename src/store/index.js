...
export default new Vuex.Store({
  state: {
    products: [
      ...
      { id: 3, name: '春梅冰茶', price: 45, image: 'https://d1ralsognjng37.cloudfront.net/e2700522-53af-4ec2-aed9-5fdfa68c802a.jpeg' },
      { id: 4, name: '麗春紅茶', price: 35, image: 'https://d1ralsognjng37.cloudfront.net/3cdbb722-db4f-40ca-9685-a0f58973be55.jpeg' },
